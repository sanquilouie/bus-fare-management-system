...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p>Your account is ready. Use the temporary credentials below to sign in.</p>
            <p><strong>Account Number:</strong> $accountNumber<br>
            <strong>Temporary Password:</strong> $pass</p>
