...
$menuItems = [
    'Superadmin' => [
        ...
        'dropdown_cashier' => [
            'Load RFID' => ['icon' => 'fa-id-card', 'url' => '/NewRam/pages/superadmin/features/activate_users.php'],
            'Remit' => ['icon' => 'fa-wallet', 'url' => '/NewRam/pages/superadmin/features/disable_users.php'],
            'Load Transaction' => ['icon' => 'fa-exchange-alt', 'url' => '/NewRam/pages/superadmin/features/transfer_user_funds.php'],
            'Remit Logs' => ['icon' => 'fa-file-invoice-dollar', 'url' => '/NewRam/pages/superadmin/features/disable_users.php'],
        ...
        'dropdown_user' => [
            'Recent Trips' => ['icon' => 'fa-route', 'url' => '/NewRam/pages/superadmin/settings.php'],
            'Convert Points' => ['icon' => 'fa-gift', 'url' => '/NewRam/pages/superadmin/settings.php'],
            'Update Password' => ['icon' => 'fa-key', 'url' => '/NewRam/pages/superadmin/settings.php'],
            'Transaction Logs' => ['icon' => 'fa-file-alt', 'url' => '/NewRam/pages/superadmin/settings.php'],
        ]
    ],
];
